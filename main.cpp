...
//			vector<string>{"Dusty"}}
//	};
//	auto query = ztl::from(petOwners).select_many([](auto&& pet_owner)
//	{
...
//		cout << *it;
//	}*/
//	/*ztl::from(petOwners).select_many([](auto&& pet_owner)
//	{
//		return pet_owner.Pets;
...
{
	vector<int> xs= { 1, 2, 3, 4, 5 };
	auto resultt = std::make_shared<vector<int>>(vector<int>({ 1, 2, 3, 4, 5 }));
